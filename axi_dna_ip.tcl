...
ip_files axi_dna [list \
  "axi_dna.v"]

add_files -fileset sources_1 axi_dna.v
add_files -fileset sim_1 axil_read.v
add_files -fileset sim_1 axil_write.v
add_files -fileset sim_1 tb_axi_dna.v

ip_properties_lite axi_dna
...
ipx::infer_bus_interface s_axil_rstn xilinx.com:signal:reset_rtl:1.0 [ipx::current_core]
